...
namespace VirtualVector.ScriptExloper
{
    ...
    public class Script_ExloporerCommand : Command
    {
        /// <inheritdoc />
        public override CommandConfiguration CommandConfiguration => new(displayName: "Show Tool Window")
        {
            ...
            // and reference it here by passing "%VirtualVector.ScriptExloper.Script_ExloporerCommand.DisplayName%" as a constructor parameter.
